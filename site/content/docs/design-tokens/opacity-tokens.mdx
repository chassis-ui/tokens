...
|------------|-------|------------|-------------|
| `opacity.base.zero` | 0 | 0% visible (fully transparent) | Invisible elements, transparent colors |
| `opacity.base.05` | 0.05 | 5% visible | Very subtle tints |
| `opacity.base.10` | 0.1 | 10% visible | Subtle color overlays |
| `opacity.base.20` | 0.2 | 20% visible | Light transparency effects |
| `opacity.base.30` | 0.3 | 30% visible | Subtle elements |
| `opacity.base.40` | 0.4 | 40% visible | Medium-light transparency |
| `opacity.base.50` | 0.5 | 50% visible | Half transparent |
| `opacity.base.60` | 0.6 | 60% visible | Medium-strong visibility |
| `opacity.base.70` | 0.7 | 70% visible | Strong visibility |
| `opacity.base.80` | 0.8 | 80% visible | Mostly opaque |
| `opacity.base.90` | 0.9 | 90% visible | Nearly solid |
| `opacity.base.95` | 0.95 | 95% visible | Almost fully opaque |
| `opacity.base.solid` | 1 | 100% visible (fully opaque) | Solid colors, no transparency |
</CxTable>
...
```json
{
  "color.palette.primary.t-5050": {
    "$type": "color",
    "$value": "rgba({color.palette.primary.50}, {opacity.base.50})"
  },
  "color.palette.black.t-30": {
    "$type": "color",
    "$value": "rgba({color.palette.black.base}, {opacity.base.30})"
  }
}
```
...
**Disabled States**: Use `opacity.context.fg-slight` (0.25) or `opacity.base.40` (0.4)

**Subtle Text**: Use `opacity.context.fg-subtle` (0.5)

**Modal Overlays**: Use `opacity.context.dim-main` (0.7) for dark overlays

**Hover Effects**: Use `opacity.base.90` or `opacity.base.80` for slightly faded hover states
