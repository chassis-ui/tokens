...
1. **Base sizes** (`size.base.*`) provide raw dimensional values (0-1024px)
...
|------------|-----------|----------|
| `size.base.0` | 0 | Zero size, no dimension |
| `size.base.1` | 1 | Minimal size, separator lines |
| `size.base.2` | 2 | Very small elements, fine borders |
| `size.base.4` | 4 | Small indicators, compact elements |
| `size.base.8` | 8 | Base grid unit, small icons |
| `size.base.12` | 12 | Small component dimensions |
| `size.base.16` | 16 | Small-medium elements |
| `size.base.20` | 20 | Small icons and badges |
| `size.base.24` | 24 | Medium icons, compact buttons |
| `size.base.28` | 28 | Medium-large icons |
| `size.base.32` | 32 | Standard button height |
| `size.base.36` | 36 | Medium-large elements |
| `size.base.40` | 40 | Standard component height |
| `size.base.48` | 48 | Large buttons and inputs |
| `size.base.56` | 56 | Extra large components |
| `size.base.64` | 64 | Hero elements, large avatars |
</CxTable>
...
| Token Name | Value (px) | Use Cases |
|------------|-----------|----------|
| `size.base.72` | 72 | Collapsed navigation |
| `size.base.96` | 96 | Large spacing, section heights |
| `size.base.120` | 120 | Menu widths, medium containers |
| `size.base.128` | 128 | Medium-large containers |
| `size.base.160` | 160 | Large containers |
| `size.base.192` | 192 | Extra large containers |
| `size.base.256` | 256 | Expanded navigation, sidebars |
| `size.base.320` | 320 | Modal widths, content areas |
| `size.base.512` | 512 | Large content areas |
| `size.base.1024` | 1024 | Maximum content widths |
</CxTable>
...
|------------|-------|--------|
| `size.base.05` | 0.5px | Half-pixel adjustments |
| `size.base.d05` | 0.05em | Relative fractional size |
| `size.base.d15` | 1.5px | 1.5-pixel increments |
| `size.base.d25` | 2.5px | 2.5-pixel increments |
| `size.base.n1` through `size.base.n24` | Negative values | Negative margins, adjustments |
</CxTable>
...
**For custom dimensions**: Use base size tokens (`size.base.*`)

### Design Principles

**Touch Targets**: Minimum 32px (size.base.32) for interactive elements on touch devices
