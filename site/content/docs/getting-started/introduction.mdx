...
sections:
  ...
  - title: Code Style Dictionary
    description: Transform tokens into platform-specific formats for web (SCSS/CSS), iOS (Swift), and Android (XML).
aliases:
 - "/getting-started"
...
Follow the appropriate guide based on your role:
...
Explore these key areas to deepen your understanding of Chassis Tokens:
