...
Generated token files will be in `Submodules/ChassisTokens/dist/ios/chassis-yourapp/`.

**Add to Xcode:**

1. Open your Xcode project
2. Right-click your project in the navigator → Add Files to "YourApp"
3. Navigate to `Submodules/ChassisTokens/dist/ios/chassis-yourapp/`
...
2. Copy all `.swift` files from `dist/ios/chassis-yourapp/` to your Xcode project
