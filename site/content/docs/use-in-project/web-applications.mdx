...
└── dist/
    └── web/
        └── [brand]-[app]/
            ├── main.scss          # All non-theme, non-screen tokens
            ├── string.scss        # String tokens only (icons, assets)
            ├── color-light.scss   # Light mode color tokens
            ├── color-dark.scss    # Dark mode color tokens
            ├── number-large.scss  # Large screen size tokens
            ├── number-medium.scss # Medium screen size tokens
            └── number-small.scss  # Small screen size tokens
```
...
- **number-[screen].scss**: Screen-size-specific numeric tokens

<Callout type="info">
By default, the package includes `chassis-docs` tokens. You can build custom combinations using the [token build process]([[docsref:/getting-started/build-tokens]]) if you're working with the repository directly.
</Callout>
...
// Import theme tokens
@import "@chassis-ui/tokens/dist/web/chassis-docs/color-light";

// Import screen tokens  
@import "@chassis-ui/tokens/dist/web/chassis-docs/number-large";
...
[data-cx-theme="dark"] {
  @import "@chassis-ui/tokens/dist/web/chassis-docs/color-dark";
...
@media (max-width: 992px) {
  @import "@chassis-ui/tokens/dist/web/chassis-docs/number-medium";
...
@media (max-width: 768px) {
  @import "@chassis-ui/tokens/dist/web/chassis-docs/number-small";
...
```javascript
// tokens.js
import tokens from '@chassis-ui/tokens/dist/web/chassis-docs/main.scss';
...
@use "@chassis-ui/tokens/dist/web/chassis-docs/main" with (
...
- Understand [theme customization]([[docsref:/getting-started/build-tokens]])
- Check [integration with Chassis CSS]([[docsref:/use-in-project/with-chassis-css]])
